...
//     loadAllReports(); // from admin-reports.js
...
//         // metric-flagged-content is updated by admin-reports.js after reports load
//     } catch (error) {
...
//     const settingsTrigger = document.querySelector('#profileDropdown [data-target="profile-view"]');
...
//     const hideModal = () => settingsModal?.classList.remove('is-visible');
//     closeX?.addEventListener('click', hideModal);
//     cancelBtn?.addEventListener('click', hideModal);
//     document.addEventListener('click', (e) => { if (e.target === settingsModal) hideModal(); });
// }
