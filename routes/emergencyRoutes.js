...
//  Self-contained — no separate controller file needed
...
// ── Inline verifyToken (mirrors server.js) ────────────────────
...
<body>
  <div class="wrapper">
    ...
    <div class="footer">HearMe - You are receiving this because you are a registered HearMe therapist.</div>
  </div>
</body>
</html>`;
}
...
<body>
  <div class="wrapper">
    ...
    <div class="footer">HearMe - You are receiving this because you activated an SOS on HearMe.</div>
  </div>
</body>
</html>`;
}
...
<body>
  <div class="wrapper">
    ...
    <div class="footer">HearMe - Thank you for making a difference.</div>
  </div>
</body>
</html>`;
}
...
//  Therapist starts call -> emails client + therapist
